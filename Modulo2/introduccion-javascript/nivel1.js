...
// let texto = 'nombreDeVariable es:' + nombreDeVariable ;

// console.log(texto + ', es un string');
...
/*
    ...
    */
    ...
    //     console.log('Nuestro número es mayor o igual que 7, y es menor a 10');
    // } else {
...
// let operador = prompt('Indique la operacion:')
// let num1 = 2
// let num2 = 3
